...
export const {changeOriginCity,changeOriginCountry,changeOptStopCity,changeOptStopCountry,changeDestinationCity,changeDestinationCountry,changeWantStop,changeOriginCityWeather,changeOptCityWeather,changeDestinationCityWeather} = citiesSlice.actions